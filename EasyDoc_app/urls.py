...
urlpatterns = [
    ...
    path('liste_hospitalisations/', views.liste_hospitalisations, name='liste_hospitalisations'),
    path('modifier_hospitalisation/', views.modifier_hospitalisation, name='modifier_hospitalisation'),
    path('supprimer-hospitalisation/', views.supprimer_hospitalisation, name='supprimer_hospitalisation'),
    ...
    path('supprimer-consultation/', views.supprimer_consultation, name='supprimer_consultation'),
    path('liste_radiologies/', views.liste_radiologies, name='liste_radiologies'),
    path('modifier_radiologie/', views.modifier_radiologie, name='modifier_radiologie'),
    path('supprimer-radiologie/', views.supprimer_radiologie, name='supprimer_radiologie'),
    path('liste_biologies/', views.liste_biologies, name='liste_biologies'),
    path('modifier_biologie/', views.modifier_biologie, name='modifier_biologie'),
    path('supprimer-biologie/', views.supprimer_biologie, name='supprimer_biologie')
